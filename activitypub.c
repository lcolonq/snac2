...
const char *mrgreencool =
    "iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAMAAAAoLQ9TAAAAIGNIUk0AAHomAACAhAAA+gAAAIDo"
    "AAB1MAAA6mAAADqYAAAXcJy6UTwAAALQUExURVZcXz9uSgqMGgCSBAeHFzhmOFJZS0xeUzlrQxR5"
    "ID9lP1BUST5oQ0xfTVRVUE1NTVVTVjpdPw97HgCMESesNjKtPTmnQk6cVEekU1qJW2iFa1aYX1CY"
    "V1qMVm5/bHp7eHCKdmOOZlOfVF2IX3OEbnd4cX94eHh/fXSOdVecU0mkRUuiR0yjSEiiREehQ0ee"
    "SEifS0OeS0uTUWeCaXp7dnx1dXpwcQSoGAmfIhOeLRucMBqZLBSZJBGhIQyoIQCjFx+PKxKZIDy4"
    "UWXWeofwm5D3oIXvkG7geja1RhOYJBOYJD50RD6JRW6/dnzCfzx/QkF0Ry96OAAyABWMKT2fTAaS"
    "HE/DYQWQFFXRYx15LQSPE1TWYWjBfAaDGQiQF0XHUlfDaAJ/EAB+DDi4Rj+ySwB5DAB1DBCMIBWI"
    "HQNxCgBoCgBqCC6kOjWmOwBkAgddDABaBQFmCz2lRzqiQwJkAwhYBgBVAwBaABp+H0ivTGjOanHY"
    "cWXMZ0qxTxZ5HwBXBAdTBwBcAABZAABaAABbAABWAABaAgBUAAVSDZ7iqaXhsarjua7ku6vjs6vm"
    "sJ3hngAZAAAOAAAIAAAHAAAJAAANAAAQAAAKAAACAAAnAPz99QAFAHKneQApAAALAAABAPr9+QAA"
    "AAA9AwAEAAARAG65dwBGBgADAAAMAEyuWwBEBwAVAAAUAAAmAF2uYWDIbEyxWApPDwAWAAAPAAAT"
    "AFzQa2jEdXWwenuve3S+dWXAalnDZGDKbWzGdW29eXK+hFTMYj6eSlmUYG2acmyibWirblGjXDqX"
    "SGTIdF3DbmHEc1bRYTObPLH5urbsvL7xwL73wanusqr+uTyoUV3RcVnLZ0PAUGPWbTaXPZ/wpdT/"
    "17P0udb/3q7/uy+eQl/ZcEe8UEW4T0y3U0OkSEqdT1KfWE6cVkScT17LbUO4UWDJaEqxT1i7XFy9"
    "X0yvU////yOkTdoAAACJdFJOUwAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
    "AAAAAAAAAAAAAAAAAAAAAAAKTpm8yryZTgolqNnw+v768NmoJSW96+u9JQr5TtqZ8Lz6vMz+/sq+"
    "+vq8mfDwmU7a2k4KqOvrqAolvevrvSUlqNnw+v768NmoJQpOmbzKmU4KtOWwNgAAAAFiS0dE77iw"
    "4qEAAAAHdElNRQfpCQ4DFQ1bEtFYAAABG0lEQVQY0wEQAe/+AAABAjc4OTo7PD0+PwMEBQYABwhA"
    "QUJDREVGR0hJSgkKCwAMS0xNiYqLjI2Oj05PUA0OAFFSkJGRkpOUlZaRlZeSmA8AU1SZlJSTmpuc"
    "nZ6fm6ChEABVVqKVk6OTpKWmlqejm6gRAFdYqaqrrK2ur7CxsrO0WRIAWlu1tre4ubq7vL2+v1xd"
    "EwBeX8DBwsPExcbHyMnKYGEUAGJjy8zNzs/Q0dLT1NVkZRUAZmfW19jZ2tvc3d7f4GhpFgBqa2zh"
    "4uPk5ebn6Oltbm8XABhwcXLq6+zt7e6vc3R1GRoAGxx2d3h5ent8fX5/gB0eHwAgISKBgoOEhYSG"
    "h4gjJCUmACcoKSorLC0uLzAxMjM0NTbX03lo3AGyWAAAACV0RVh0ZGF0ZTpjcmVhdGUAMjAyNS0w"
    "OS0xNFQwMzoyMTowNyswMDowMAUCC5QAAAAldEVYdGRhdGU6bW9kaWZ5ADIwMjUtMDktMTRUMDM6"
    "MjA6NTQrMDA6MDDilczvAAAAKHRFWHRkYXRlOnRpbWVzdGFtcAAyMDI1LTA5LTE0VDAzOjIxOjEz"
    "KzAwOjAwG6+2egAAABR0RVh0bWltZTp0eXBlAGltYWdlL3dlYnAdlz4/AAAAAElFTkSuQmCC";
...
/* returns the default avatar in base64 */
{
    ...
    if (tm.tm_wday == 3)
        p = mrblue;
    else if (tm.tm_wday == 2 || tm.tm_wday == 5)
        p = mrgreencool;
